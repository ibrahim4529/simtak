...
<head>
    ...
    <link rel="stylesheet" href="{{url('adminlte/bower_components/datatables-bs/css/dataTables.bootstrap.min.css')}}">
...
<body class="hold-transition @if(Auth::user()) skin-green sidebar-mini fixed @else login-page @endif">
@if(Auth::user())
    <div class="wrapper">
...
<!-- datepicker -->
<script
    src="{{url('adminlte/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')}}"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="{{url('adminlte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')}}"></script>
<script src="{{url('adminlte/bower_components/datatables/js/jquery.dataTables.min.js')}}"></script>
<script src="{{url('adminlte/bower_components/datatables-bs/js/dataTables.bootstrap.min.js')}}"></script>
<!-- Slimscroll -->
